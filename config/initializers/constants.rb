module Constants
  VEHICLE_DETAILS_UPLOAD_HEADERS = ["Id", "Finance Company Name", "Loan Agreement Number", "Company", "Model", "Reg No", "Engine No", "Chasis No", "KMS Driven", "Year Of Manufacturing", "Location", "City", "State", "Pincode", "Stock Entery Date", "Buy Price", "Expenses", "Sale Price", "Commission", "Due", "Status", "Remarks"]
